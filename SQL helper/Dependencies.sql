...
with tables as (
--    union all
    select 'AE_AML' as schema, 'AML_T_B2B_OR_REPORT_FINAL' as table_name from dual
    union all
    select 'C23833' as schema, 'V_CSABA_SRC2' as table_name from dual
    union all
    select 'AE_AML' as schema, 'AML_T_B2B_OR_REPORT' as table_name from dual
    union all
    select 'AE_AML' as schema, 'POCSOM_XXX_YYY' as table_name from dual
/*    union all
    select 'AE_AML' as schema, 'AML_T_CORP_KNOWN_HH_LOSSES' as table_name from dual
    union all
    select 'AE_AML' as schema, 'AML_T_DM_OR_ARCHIVE' as table_name from dual
    union all
    select 'AE_AML' as schema, 'AML_T_DM_VALUE_MODEL_1A' as table_name from dual
    union all
    select 'AE_AML' as schema, 'AML_T_DM_VALUE_MODEL_1B' as table_name from dual
    union all
    select 'AE_BDM' as schema, 'BDM_T_MPD_HISTORY' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_BSMT_E_METER_PT_DATA' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_FLIPI_MPAN_DETAIL' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_FLIPI_MPAN_DETAIL' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_FLIPI_MPAN_DETAIL' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MA98_EUOS_SITE_METER' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MA98_LINE_LOSS_FACTOR' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MA98_LLF_USAGE' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MA98_MS_REG_INSTR' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MDD_LLF_DIST' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MDD_MTC_LLF_DIST_COMBO' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MDD_MTC_LLF_SSC_DIST_COM' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MDD_MTC_LLF_SSC_PC_COMBO' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_MDD_VALID_TOP_LINES_NHH' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_RECON_MPAS_CURRENT' as table_name from dual
    union all
    select 'AE_HDS' as schema, 'HDS_T_SETT_MPAS_REFR_DTLS' as table_name from dual
    union all
    select 'AE_STG_AML' as schema, 'STG_AML_T_CORP_MPAS_CURRENT' as table_name from dual
    union all
    select 'AE_STG_BDM' as schema, 'STG_BDM_T_MDH_DELTA' as table_name from dual */
--with tables as (
