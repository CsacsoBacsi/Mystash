...
#*                                                                             *
#* Description : Batch process to send output files to downstream systems.     *
#*               Could be FTP or just a network copy depending on the type     *
#*               of file.                                                      *
#*                                                                             *
#*******************************************************************************
...
#* 10/05/11      Csaba Riedlinger 1.1     Archive sub directory setting added  *
#* 11/05/11      Csaba Riedlinger 1.1     Loop for 58 mins introduced          *
#* 20/05/11      S.K.Rattu        1.2     corrected ftp_ascii_put and ftp_binary*
#*                                        put.                                 *
#* 08/06/11      Csaba Riedlinger 1.3     If file is not fully output i.e. no  *
#*                                        file detail history record, system   *
#*                                        simply moves on to next file in dir. *
#* 10/06/11      Csaba Riedlinger 1.4     Archive file name postfixed by curr  *
#*                                        timestamp. gzip has -f switch now    *
#* 15/06/11      Csaba Riedlinger 1.5     Transfer mode is now used in network *
#*                                        copy. Unix2dos converter is used when*
#*                                        necessary to convert in ASCII mode.  *
#* 28/09/11      D. Ballantyne    1.6     Modified to reduce sleep time from   *
#*                                        60 seconds to 10 seconds. Effect is  *
#*                                        that polling frequency is increased  *
#*                                        without increasing number of database*
#*                                        accesses as the script accesses the  *
#*                                        database only when it has a file.    *
#* 10/11/11      Nick Keay        1.7     Change SQL call to PAL version       *
#*******************************************************************************
...
do
   ...
   ut_run_spu value "SELECT wet_cnf.pkg_wet_utility.fn_get_output_system_details('$file') FROM dual"
...
# Sleep for a minute
# sleep 60 ----> Changed to 10 seconds below...
sleep 10 
